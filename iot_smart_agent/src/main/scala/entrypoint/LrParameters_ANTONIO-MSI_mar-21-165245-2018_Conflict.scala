...
object LrParameters {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //final val iterations = Array(10)
     val leftValue  = 1.00E-10
     val rightValue = 1.00E-07
     val step       = 1.00E-10

    // val windows =Array(3,4,6,12,24,90,180,360,720,1080)
    val windows =Array(1080)
     val exp = "lux"
    var trainingPath = ""
    var testPath = ""
    var ouputPath =""
    ...
    var ceros=""
     for (window <-windows) {
       ...
       var trainingPath = "/mnt/datos/amfergom/nas/proyectos/iot_smart_agent/fuentes/dataset_experiments/exp_" + exp + "_test/w_" + ceros + window + "/pre_training"
       var testPath = "/mnt/datos/amfergom/nas/proyectos/iot_smart_agent/fuentes/dataset_experiments/exp_" + exp + "_test/w_" + ceros + window + "/pre_test"
       var ouputPath = "/mnt/datos/amfergom/nas/proyectos/iot_smart_agent/fuentes/dataset_experiments/exp_" + exp + "_test/w_" + ceros + window + "/paramStudy"
